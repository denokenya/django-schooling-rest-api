...
class TituloEleitoral(BaseDoc):
    ...
    def validate(self, doc: str = "") -> bool:
        ...
        second_check_digit = self._compute_second_check_digit(
            doc_digits=doc_digits, first_check_digit=first_check_digit
        )
    ...
    def generate(self, mask: bool = False) -> str:
        ...
        second_check_digit = self._compute_second_check_digit(
            doc_digits=document_digits, first_check_digit=first_check_digit
        )
    ...
    def _compute_second_check_digit(
        self, doc_digits: List[int], first_check_digit: int
    ) -> int:
