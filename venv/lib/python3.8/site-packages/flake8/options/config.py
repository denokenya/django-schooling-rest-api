...
class MergedConfigParser(object):
    ...
    def parse_local_config(self):
        ...
        if not self.is_configured_by(config):
            LOG.debug("Local configuration files have no %s section", self.program_name)
            return {}
    ...
    def parse_user_config(self):
        ...
        if not self.is_configured_by(config):
            LOG.debug("User configuration files have no %s section", self.program_name)
            return {}
    ...
    def parse_cli_config(self, config_path):
        ...
        if not self.is_configured_by(config):
            LOG.debug("CLI configuration files have no %s section", self.program_name)
            return {}
