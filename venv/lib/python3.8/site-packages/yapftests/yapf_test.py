...
class CommandLineTest(unittest.TestCase):
    ...
    def testUnicodeEncodingPipedToFile(self):
        ...
        with utils.NamedTempFile(dirname=self.test_tmpdir, suffix=".py") as (out, _):
            with utils.TempFileContents(
                self.test_tmpdir, unformatted_code, suffix=".py"
            ) as filepath:
    ...
    def testSetYapfStyle(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--style=yapf"]
        )
            ...
            with utils.TempFileContents(
                ...
                try:
                    subprocess.check_call(
                        YAPF_BINARY + ["--diff", filepath], stdout=out
                    )
...
"""
    ...
    def testRetainVerticalFormattingBetweenDisabledLines(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, extra_options=["--lines", "4-4"]
        )
...
"""
    ...
    def testCP936Encoding(self):
        ...
        self.assertYapfReformats(
            unformatted_code, expected_formatted_code, env={"PYTHONIOENCODING": "cp936"}
        )
