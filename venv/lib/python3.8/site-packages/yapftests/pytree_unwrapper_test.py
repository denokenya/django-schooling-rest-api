...
class PytreeUnwrapperTest(yapf_test_helper.YAPFTest):
    ...
    def testSimpleFileScope(self):
      ...
      """
        ...
        self._CheckUnwrappedLines(
            uwlines, [(0, ["x", "=", "1"]), (0, ["# a comment"]), (0, ["y", "=", "2"])]
        )
    ...
    def testSimpleMultilineStatement(self):
      ...
      """
        ...
        uwlines = yapf_test_helper.ParseAndUnwrap(code)
        self._CheckUnwrappedLines(uwlines, [(0, ["y", "=", "(", "1", "+", "x", ")"])])
...
class MatchBracketsTest(yapf_test_helper.YAPFTest):
    ...
    def testFunctionDef(self):
        ...
        uwlines = yapf_test_helper.ParseAndUnwrap(code)
        self._CheckMatchingBrackets(uwlines, [[(2, 20), (7, 11), (15, 19)], []])
    ...
    def testDecorator(self):
        ...
        uwlines = yapf_test_helper.ParseAndUnwrap(code)
        self._CheckMatchingBrackets(uwlines, [[(2, 3)], [(2, 8)], []])
    ...
    def testClassDef(self):
        ...
        uwlines = yapf_test_helper.ParseAndUnwrap(code)
        self._CheckMatchingBrackets(uwlines, [[(2, 8)], []])
