...
"""
    ...
    def testMultilineDictionaryKeys(self):
        ...
        try:
            style.SetGlobalStyle(
                style.CreateStyleFromConfig(
                    "{based_on_style: yapf, " "allow_multiline_dictionary_keys: true}"
                )
            )
            uwlines = yapf_test_helper.ParseAndUnwrap(unformatted_code)
            self.assertCodeEqual(expected_formatted_code, reformatter.Reformat(uwlines))
    ...
    def testBlankLineBeforeClassDocstring(self):
        ...
        try:
            style.SetGlobalStyle(
                style.CreateStyleFromConfig(
                    "{based_on_style: yapf, " "blank_line_before_class_docstring: True}"
                )
            )
...
"""
    ...
    def testDisableEndingCommaHeuristic(self):
        ...
        try:
            style.SetGlobalStyle(
                style.CreateStyleFromConfig(
                    "{based_on_style: yapf," " disable_ending_comma_heuristic: True}"
                )
            )
    ...
    def testDedentClosingBracketsWithTypeAnnotationExceedingLineLength(self):
        ...
        try:
            style.SetGlobalStyle(
                style.CreateStyleFromConfig(
                    "{based_on_style: yapf," " dedent_closing_brackets: True}"
                )
            )
    ...
    def testIndentClosingBracketsWithTypeAnnotationExceedingLineLength(self):
        ...
        try:
            style.SetGlobalStyle(
                style.CreateStyleFromConfig(
                    "{based_on_style: yapf," " indent_closing_brackets: True}"
                )
            )
