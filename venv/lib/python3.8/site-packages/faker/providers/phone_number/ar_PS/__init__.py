...
class Provider(PhoneNumberProvider):
    ...
    toll_foramts = ("1 700 ### ###", "1-700-###-###", "1 800 ### ###", "1-800-###-###")

    services_phones_formats = ("100", "101", "102")

    formats = (
        cellphone_formats + telephone_formats + services_phones_formats + toll_foramts
    )

    def provider_code(self):
        return self.random_element(["59", "56"])

    def area_code(self):
        return self.random_element(["00972", "+972", "00970", "+970"])
