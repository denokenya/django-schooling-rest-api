...
class BaseProvider:
    ...
    def locale(self):
        ...
        return (
            language_code
            + "_"
            + self.random_element(BaseProvider.language_locale_codes[language_code])
        )
    ...
    def random_letters(self, length=16):
        ...
        return self.random_choices(
            getattr(string, "letters", string.ascii_letters), length=length
        )
    ...
    def random_elements(self, elements=("a", "b", "c"), length=None, unique=False):
        ...
        return fn(
            list(choices), list(probabilities), self.generator.random, length=length
        )
