...
class Provider(BaseProvider):
    ...
    def firefox(self):
        ...
        ver = (
            "Gecko/{} Firefox/{}.0".format(
                self.generator.date_time_between(datetime(2011, 1, 1)),
    ...
    def safari(self):
        ...
        saf = "{}.{}.{}".format(
            self.generator.random.randint(531, 535),
            self.generator.random.randint(1, 50),
            self.generator.random.randint(1, 7),
        )
        if not self.generator.random.getrandbits(1):
            ver = "{}.{}".format(
                self.generator.random.randint(4, 5), self.generator.random.randint(0, 1)
            )
        else:
            ver = "{}.0.{}".format(
                self.generator.random.randint(4, 5), self.generator.random.randint(1, 5)
            )
        tmplt_win = (
    ...
    def internet_explorer(self):
        ...
        return tmplt.format(
            self.generator.random.randint(5, 9),
            self.windows_platform_token(),
    ...
    def linux_platform_token(self):
        ...
        return "X11; Linux {}".format(self.random_element(self.linux_processors))
