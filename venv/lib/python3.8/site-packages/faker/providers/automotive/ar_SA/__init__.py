...
class Provider(AutomotiveProvider):
    ...
    def license_plate_en(self):
        ...
        return self.bothify(self.LICENSE_FORMAT_EN, letters=self.PLATE_CHARS_EN)
    ...
    def _translate_license_plate(self, license_plate):
        ...
        numerated = re.sub(
            r"\#", lambda x: self.PLATE_MAP[nums.pop()], self.LICENSE_FORMAT_AR
        )
        ar_plate = re.sub(r"\?", lambda x: self.PLATE_MAP[chars.pop()], numerated)
