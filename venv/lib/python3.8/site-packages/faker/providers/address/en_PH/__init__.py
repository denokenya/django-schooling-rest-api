...
class Provider(AddressProvider):
    ...
    floor_numbers = OrderedDict(
        ...
        + [
            (str(x), 0.32356832089420257 / x)
            for x in range(5, 13)  # Floors 5 to 12, 33% of the time
        ]
        + [
            (str(x), 0.30341265418486174 / (x - 1))
            for x in range(14, 30)  # Floors 14 to 29, 25% of the time
        ]
        + [
            (str(x), 0.30096338222652870 / (x - 1))
            for x in range(30, 50)  # Floors 30 to 49, 16% of the time
        ]
        + [
            (str(x), 0.04570476167856688 / (x - 1))
            for x in range(50, 75)  # Floors 50 to 74, 1.9% of the time
        ]
        + [
            (str(x), 0.003415677066138734 / (x - 1))
            for x in range(75, 100)  # Floors 75 to 99, 0.1% of the time
        ]
    )
    ...
    def floor_unit_number(self):
        return "{floor_number}{unit_number:02d}".format(
            floor_number=self.floor_number(), unit_number=self.random_int(1, 40)
        )
