...
class Provider(BaseProvider):
    ...
    def null_boolean(self):
        ...
        :sample size=15:
        """
        return {0: None, 1: True, -1: False}[self.generator.random.randint(-1, 1)]
    ...
    def sha256(self, raw_output=False):
        ...
        :sample: raw_output=True
        """
        res = hashlib.sha256(str(self.generator.random.random()).encode())
        if raw_output:
            return res.digest()
        return res.hexdigest()
    ...
    def zip(
        self, uncompressed_size=65536, num_files=1, min_file_size=4096, compression=None
    ):
        ...
        with zipfile.ZipFile(
            zip_buffer, mode="w", compression=compression
        ) as zip_handle:
    ...
    def json(
        self, data_columns: list = None, num_rows: int = 10, indent: int = None
    ) -> str:
        """
        ...
        """
        default_data_columns = {"name": "{{name}}", "residency": "{{address}}"}
    ...
    def fixed_width(
        self, data_columns: list = None, num_rows: int = 10, align: str = "left"
    ) -> str:
        """
        ...
        """
        default_data_columns = [(20, "name"), (3, "pyint", {"max_value": 20})]
        data_columns = data_columns if data_columns else default_data_columns
