...
class Faker:
    ...
    def __init__(
        self, locale=None, providers=None, generator=None, includes=None, **config
    ):
        ...
        for locale in locales:
            self._factory_map[locale] = Factory.create(
                locale, providers, generator, includes, **config
            )
    ...
    def _map_provider_method(self, method_name):
        ...
        if self._weights:
            ...
            value = [
                factory for factory in self.factories if hasattr(factory, method_name)
            ]
            mapping = value, None
        ...
        def wrapper(*args, **kwargs):
            ...
            for i in range(_UNIQUE_ATTEMPTS):
                ...
                raise UniquenessException(
                    "Got duplicated values after {0:,} iterations.".format(
                        _UNIQUE_ATTEMPTS
                    )
                )
